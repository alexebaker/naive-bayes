...
def main():
    ...
    parsed_matrix = nb.get_parsed_matrix(cli_args.get('training_csv'), training_matrix_file)
    ...
    parsed_matrix = nb.get_parsed_matrix(cli_args.get('testing_csv'), testing_matrix_file)
    ...
    nb.save_classification(parsed_matrix, cli_args.get('classification_file'))
    return
